...
export default function AboutPage() {
  return (
    <Container maxWidth="md" sx={{ py: 8, mt: 8 }}>
      ...
      <Typography variant="body1">
        I grew up on a cattle ranch in Nebraska, and helping my mom prepare meals for my family and workers on the ranch was a part of life from a very early age. (Ranch cooking = I've been a wizard at frying pretty much any kind of meat or vegetable since the age of 9.) I developed some basic baking skills early, too, but I never really challenged myself or experimented with baking a few years ago. It started with a Nutella shortbread recipe that a friend posted, and the next thing I knew was I researching the intricacies of laminating dough to make croissants. I've been hooked ever since 🥐
      </Typography>
      ...
      <Typography variant="body1">
        ...
        check out the code base <Link href="https://github.com/kristenburgess25/kristen-loves-cookies"
                                      target="_blank">here</Link>. Submitting issues/features is very welcome! 🤓
        <br/>
